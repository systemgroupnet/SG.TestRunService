...
namespace SG.TestRunService.Migrations
{
    ...
    [Migration("20200412083752_ExtractCodeSignatureTable")]
    partial class ExtractCodeSignatureTable
    {
            ...
            modelBuilder.Entity("SG.TestRunService.Data.TestCaseImpactItem", b =>
                {
                    ...
                    b.HasIndex("AzureProductBuildDefinitionId", "IsDeleted")
                        .HasAnnotation("SqlServer:Include", new[] { "TestCaseId", "CodeSignatureId" });

                    b.HasIndex("TestCaseId", "AzureProductBuildDefinitionId", "CodeSignatureId")
                        .IsUnique();
